...
const SignupForm = ({ text = 'Subscribe' }) => (
  <form
...
const Subtitle = ({ text = "Find the right charity. Get reports on your donations.", subtext = "Build trust and a better society."}) => (
